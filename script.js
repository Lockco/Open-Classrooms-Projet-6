...
// Fonction relative au meilleur film
...
// Contrôle de la modal et extraction des informations
...
function fetchModalData(id) {
    ...
    fetch(mainUrl + id)
        ...
        .then(data => {
            ...
            // On test si l'information existe, dans le cas contraire on renvoi indisponible
            if (data["worldwide_gross_income"] == null)
                modalBoxOffice.innerHTML = "indisponible";  
            else
...
async function buildCarousel(category, name, skip = 0) {
    ...
    for (const movie of movies) {
        ...
        modalButton.setAttribute("title",'Détails')
        modalButton.innerHTML = '<i class="fa-solid fa-circle-chevron-down"></i>';
    ...
    leftButton.setAttribute("title",'Précédent');
    ...
    rightButton.setAttribute("title",'Suivant');
